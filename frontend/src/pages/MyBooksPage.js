    ...
    <div className="books-page">
      ...
      >
        <form className="add-book-form" onSubmit={handleAddBookSubmit}>
          <button className="close-button" onClick={() => setShowAddBookForm(false)}>
            ×
          </button>
      ...
      >
        <form className="add-book-form" onSubmit={handleEditBookSubmit}>
          <button className="close-button" onClick={() => setShowEditBookForm(false)}>
            <FaTimes />
          </button>
      ...
      >
        <div className="add-book-form" style={{textAlign:'center', maxWidth: 340}}>
          ...
          <div style={{display:'flex', gap:16, justifyContent:'center'}}>
            <button onClick={confirmDeleteBook} className="delete-confirm-button">Удалить</button>
            <button onClick={cancelDeleteBook} className="cancel-button">Отмена</button>
          </div>
        </div>
      </Modal>
